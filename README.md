...
1- Installare poetry assicurando che sia locato sulla macchina con successo controllandone la versione del programma.
2- Installare le librerie sull'ambiente viruale che permettono al microservice di lanciare il programma.
3- Lanciare il codice assicurandosi che le porte dentro lo script code_base.py (linea 64) e live_agent.js (linea 349) siano allineati.
4- Aprire il file formicaio_webpage.html per testare in locale l'applicazione.
